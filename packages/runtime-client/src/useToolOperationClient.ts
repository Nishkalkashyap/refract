...
export const DEFAULT_PLUGIN_ENDPOINT = "/api/refract/plugin";

export async function invokeToolOperation(
...
export function useToolOperationClient(serverEndpoint = DEFAULT_PLUGIN_ENDPOINT) {
  return useCallback(
    async (
      ...
      return invokeToolOperation(serverEndpoint, pluginId, selectionRef, payload);
    },
    [serverEndpoint]
  );
}
